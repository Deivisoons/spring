...
public class ColaboradorControle {
	...
	@RequestMapping(value="/colaborador/ultimoRegistro", method=RequestMethod.GET)
	public @ResponseBody ColaboradorModelo ultimoRegistro() {
		return this.colaboradorRepositorio.findTopByOrderByCodigoDesc();
	} 
